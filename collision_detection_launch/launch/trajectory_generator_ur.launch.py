...
def launch_setup(context, *args, **kwargs):
    ...
    robot_description_semantic_content = Command(
        [
            ...
            PathJoinSubstitution(
                [FindPackageShare(moveit_config_package), "config","srdf", moveit_config_file]
            ),
            " ",
            "name:=",
    ...
    kinematics_yaml = load_yaml("collision_detection_launch", "config/kinematics.yaml")
    ...
    ompl_planning_yaml = load_yaml("collision_detection_launch", "config/ompl_planning.yaml")
    ompl_planning_pipeline_config["move_group"].update(ompl_planning_yaml)

    # Trajectory Execution Configuration
    controllers_yaml = load_yaml("collision_detection_launch", "config/controllers.yaml")
    moveit_controllers = {
    ...
    trajectory_generator_node = Node(
        package="collision_detection_launch",
